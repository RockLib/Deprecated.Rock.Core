...
namespace Rock.Extensions
{
	public static partial class FuncExtensions
	{
		...
		/// </code>
		/// </example>
		public static async Task RetryAsync(this Func<Task> func, int retryCount, int millisecondRetryDelay)
		{
			retryCount--;
			do
			{
		...
		public static async Task RetryAsync<TException1, TException2, TException3>(this Func<Task> func, int retryCount, int millisecondRetryDelay)
		...
		public static Task RetryAsync<TException1, TException2>(this Func<Task> func, int retryCount, int millisecondRetryDelay)
			where TException1 : Exception
			where TException2 : Exception
		{
			return RetryAsync<TException1, TException2, TException2>(func, retryCount, millisecondRetryDelay);
		}

		public static Task RetryAsync<TException1>(this Func<Task> func, int retryCount, int millisecondRetryDelay)
			where TException1 : Exception
		{
			return RetryAsync<TException1, TException1, TException1>(func, retryCount, millisecondRetryDelay);
		}
		#endregion no-args
		#region args
		public static async Task RetryAsync<TArg>(this Func<TArg, Task> func, TArg arg1, int retryCount, int millisecondRetryDelay)
		{
			retryCount--;
			do
			{
		...
		public static async Task RetryAsync<TArg1, TArg2>(this Func<TArg1, TArg2, Task> func, TArg1 arg1, TArg2 arg2, int retryCount, int millisecondRetryDelay)
		{
			retryCount--;
			do
			{
		...
		public static async Task RetryAsync<TArg, TException1, TException2, TException3>(this Func<TArg, Task> func, TArg arg1, int retryCount, int millisecondRetryDelay)
			where TException1 : Exception
			where TException2 : Exception
			where TException3 : Exception
		{
		...
		public static Task RetryAsync<TArg, TException1, TException2>(this Func<TArg, Task> func, TArg arg1, int retryCount, int millisecondRetryDelay)
			where TException1 : Exception
			where TException2 : Exception
		{
			return RetryAsync<TArg, TException1, TException2, TException2>(func, arg1, retryCount, millisecondRetryDelay);
		}

		public static Task RetryAsync<TArg, TException1>(this Func<TArg, Task> func, TArg arg1, int retryCount, int millisecondRetryDelay)
			where TException1 : Exception
		{
			return RetryAsync<TArg, TException1, TException1, TException1>(func, arg1, retryCount, millisecondRetryDelay);
		}
		#endregion args
#endif
		#endregion async void retries

		#region Func async retries
		/// <summary>
		/// Try an asynchronous delegate up to <paramref name="retryCount"/> times with <paramref name="millisecondRetryDelay"/> ms delay between retries.
		/// </summary>
